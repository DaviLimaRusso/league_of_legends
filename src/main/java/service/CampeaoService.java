...
public interface CampeaoService {
    ...
    void skillDois (Campeao danoEfetuadoSkillDois, Campeao danoRecebidoSkillDois, int valorAtaqueSkillDois) throws Exception;
    void skillTres (Campeao danoEfetuadoSkillTres, Campeao danoRecebidoSkillTres, int valorAtaqueSkillTres) throws Exception;
